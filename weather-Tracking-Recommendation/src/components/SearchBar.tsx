...
export default function SearchBar({ onSearch, loading }: SearchBarProps) {
 ...
 className="w-full pl-11 pr-3 py-3 rounded-2xl bg-slate-50 border border-slate-200 text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-sky-400/50 text-sm"
 />
 </div>
 </div>
 ...
 type="submit"
 disabled={loading}
 className="w-full inline-flex items-center justify-center gap-2 px-5 py-3 rounded-2xl bg-gradient-to-r from-blue-500 via-sky-500 to-yellow-400 text-white font-semibold text-sm shadow-xl shadow-sky-400/30 transition-all duration-300 hover:brightness-110 hover:scale-[1.02] active:scale-[0.98] disabled:opacity-60 disabled:cursor-not-allowed"
 >
 {loading ? (
