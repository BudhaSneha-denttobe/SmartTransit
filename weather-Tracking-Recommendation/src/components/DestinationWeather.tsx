...
import type { DestinationWeatherDetail, HourlyForecast, DailyForecast } from '../types';

interface DestinationWeatherProps {
 weather: DestinationWeatherDetail | null;
 hourly: HourlyForecast[];
 daily: DailyForecast[];
}

export default function DestinationWeather({ weather, hourly, daily }: DestinationWeatherProps) {
 ...
 >
 <p className="w-14 text-sm font-medium text-slate-700 ">
 {d.day}
 </p>
