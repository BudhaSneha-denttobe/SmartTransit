...
const weatherBgMap: Record<string, string> = {
 ...
 'Mostly Cloudy': 'from-gray-300 to-gray-500',
 'Rain Expected': 'from-blue-400 to-indigo-500',
 'Cloudy': 'from-gray-400 to-gray-600',
};

export default function RouteOverview({ data }: RouteOverviewProps) {
 const gradient = weatherBgMap[data.currentWeather] || 'from-blue-400 to-blue-600';
