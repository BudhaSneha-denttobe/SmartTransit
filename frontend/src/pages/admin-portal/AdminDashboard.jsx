    ...
    <div className="space-y-6">
        ...
        {cards.map((card) => (
          ...
          >
            <div className="flex items-center justify-between">
              ...
              <span className="material-symbols-outlined text-4xl opacity-30">{card.icon}</span>
            </div>
          </div>
        ))}
      </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-lg font-semibold text-gray-900">Recent Buses</h2>
          <Link
            to="/admin-portal/buses"
                ...
                {stats.recentBuses.map((bus) => (
                  <tr key={bus._id} className="border-b border-gray-100">
                    ...
                    <td className="py-3 text-gray-700">
                      {bus.source} &rarr; {bus.destination}
                    </td>
                    <td className="py-3">
